...
本隐私政策适用于厦门多普勒科技有限公司及其关联公司提供的所有产品和服务，包括但不限于：官方网站（含移动端适配版）、无影（SnapWipe）软件、管理后台系统、API接口服务、技术支持服务等。本政策涵盖个人信息从收集、使用、存储、加工、传输到删除或匿名化处理的全生命周期。当您使用我们的服务时，即表示您同意我们按照本政策处理您的个人信息。若您通过第三方平台或渠道访问我们的服务，除适用本政策外，还应遵守第三方平台的隐私政策。
