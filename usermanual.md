...
1. 锁定后在目标设备上显示的锁屏信息，如“会议期间，请勿使用手机”。[[锁屏图例]](./assets/locked.jpeg)<a href="./assets/locked.jpeg" target="_blank" rel="noopener noreferrer">[锁屏图例]</a>也可以留空，不填写任何信息，锁屏后和用户自己关上屏幕的效果一致。
