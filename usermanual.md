...
1. 锁定后在目标设备上显示的锁屏信息，如“会议期间，请勿使用手机”。<a href="./assets/locked.jpeg" target="_blank" rel="noopener noreferrer">[锁屏图例]</a> 也可以留空不填，这样锁屏后和用户自己关上屏幕的效果一致，不会在屏幕上显示任何信息。
...
该模式的核心目标是：​**在设备丢失后，阻止未经授权的用户访问设备数据，并通过远程控制实现设备定位与找回**​。与传统用户手动开启的“丢失模式”不同，“受管理的丢失模式”完全由MDM服务器控制，不受用户个人Apple ID或设置的影响，是企业级设备管理的专属功能。



### 锁机

丢失模式下的锁机在某些场合也叫 **监管锁**，它的作用是在设备丢失后，通过给设备加锁，防止被他人使用。锁机后用户无法通过锁屏密码解锁，因此在管理员解锁前，该设备无法正常使用。
